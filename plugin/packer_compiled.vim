...
_G.packer_plugins = {
  ...
  ["nvim-compe"] = {
    after_files = { "/Users/utkarshmalik/.local/share/nvim/site/pack/packer/opt/nvim-compe/after/plugin/compe.vim" },
    loaded = false,
    needs_bufread = false,
  ...
  vim = {
    loaded = true,
    path = "/Users/utkarshmalik/.local/share/nvim/site/pack/packer/start/vim"
  },
  ["vim-code-dark"] = {
    loaded = true,
